  ...
  return (
    ...
    <div className="h-screen bg-background w-[300px]">
      <div className="hidden md:flex flex-col p-2 border border-black m-2 bg-zinc-50">
        ...
        <form action={enviarCodigo} className="flex flex-col gap-2 bg-zinc-50" >
          ...
          <textarea required name="contenido" id="contenido" className="w-full h-96 border border-black p-1" placeholder="escribir codigo"></textarea>
